...
def main():
    ...
    chain_sequences = ["AGAGAGAGAGAGAGAGAGA"]
    first_spindoals = []
    output_data = []
    for chain_sequence in chain_sequences:
        ...
        aro_comp_fraction = sum([1 if i == 'A' else 0 for i in chain_sequence])/len(chain_sequence)
        glu_comp_fraction = 1-aro_comp_fraction
        DS = get_species_counts(chain_sequence,dw=1e-5,max_conc=0.09)
        phase_transitions = {}
        stability_data = []
        RPA_OBJECTS = {}
        for key, species_counts_data in DS.items():
            ...
            if len(key) == 2 and key[0] == 1.0: # fully deprotonated case
                ...
                RS = RPA_OBJECTS[key]
                RS.ff_file = './cg_ff_GLUd_only.dat'
                RS.out = 'ARO_GLU'
                RS.bondtype = 'offset'
                RS.r_max = 10.
                RS.n_r = 10000
                ...
                RS.n_k = 10000
                n = 1000
                RS.beadtypes = [['HOH', 0.31, 0], ['ARO', 0.75, 0], ['GLUd', 0.75, -1], ['TMA', 0.31, 1], ['OH', 0.31, -1]]
                ...
                RS.n_k = 10000
                n = 1000
                RS.beadtypes = [['HOH', 0.31, 0], ['ARO', 0.75, 0], ['GLUp', 0.75, -1], ['TMA', 0.31, 1], ['OH', 0.31, -1]]
                RS.moltypes = [['HOH',[0]], ['TMA',[3]], ['OH',[4]], ['Chain',chain_mol_beads]]
                RS.molbonds = [['HOH',[]], ['TMA',[]], ['OH',[]], ['Chain',[[idx,idx+1] for idx in range(chain_len-1)]]]
                ...
                RPA_OBJECTS[key] = RPA.RPAsystem()
                RS = RPA_OBJECTS[key]
                RS.ff_file = './cg_ff_GLUd_GLUp.dat'
                RS.out = 'ARO_GLU'
                RS.bondtype = 'offset'
                RS.r_max = 10.
                RS.n_r = 10000
                ...
                n = 1000
                if has_h3o:
                    RS.beadtypes = [['HOH', 0.31, 0], ['ARO', 0.75, 0], ['GLUd', 0.75, -1],['GLUp', 0.75, 0], ['TMA', 0.31, 1], ['H3O', 0.31, 1]]
                    ...
                    RS.beadtypes = [['HOH', 0.31, 0], ['ARO', 0.75, 0], ['GLUd', 0.75, -1],['GLUp', 0.75, 0], ['TMA', 0.31, 1]]
        ...
        with open("ARO_GLU_RPA.txt", "w") as f: # [C_W,C_TMA,C_OH,C_CHAIN,C_H3O]
        ...
        stability_all = []
        polymer_concs = []
        with open("ARO_GLU_RPA.txt","r") as f:
