...
def transition_density_analysis():
    ...
    plt.savefig("plots/transition_density_norm.png")
...
def hydrophobic_fraction():
    ...
    plt.savefig("plots/hydrophobic_fraction_N5_N10.png")
    exit()
    ...
    plt.xlabel(r"$f_A$")
    plt.legend(title=r"$N$")
    plt.savefig("plots/hydrophobic_fraction.png")
...
def plot_local_autocorrelation():
    ...
    plt.xlim(-1.1, 1.1)
    plt.savefig("plots/local_autocorrelation.png")
...
def plot_solvo_block_len():
    ...
    plt.savefig("plots/avg_hydropholic_block.png")
    #df = pd.DataFrame(y)
    #df.to_csv('scratch.csv',index=False)
...
def plot_screening():
    ...
    plt.ylabel(r"$w^*_{poly}$")
    plt.legend(title=r"$N = $20")
    plt.savefig("plots/screen_score_all.png")
...
def plot_autcorr():
    ...
    plt.ylabel(r"$w^*_{poly}$")
    plt.legend(title=r"$N = $20")
    plt.savefig("plots/autocorr_all.png")
...
def main():
    ...
    plt.ylabel(r"$w^*_{poly}$")
    plt.legend(title=r"$N = $20")
    plt.savefig("plots/screening_score_prev_ff.png")
main()
